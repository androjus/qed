def test_run_predict_success(
    client, input_data_predict, mock_representativeness
):
    response = client.post(
        "api/predict/use", json=input_data_predict.model_dump()
    )
